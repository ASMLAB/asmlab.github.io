...
### Peer-reviewed paper
--------------
{{< expand  "Kwak, K., H. Song, N. Yeo, E.-C. Chang, M.-S. Koo, E. Lee and J. Park, Improved subseasonal prediction of Atmospheric Energy Transport over the Northwest Pacific using an atmosphere-ocean coupled model. Monthly Weather Review, *in press*" >}}
#### Abstract
...
{{< expand  "Kim, Y., H. Song, K. Han, S.-I. Ah, Y.-G. Park, J. Marshall, Residual overturning circulation and associated water-mass transformation in the East/Japan Sea, *Journal of Physical Oceanography*, *in press*" >}}
#### Abstract
